                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('admin.add_role') }}" class="btn btn-primary waves-effect waves-light">Add
                                Roles</a>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.edit_role',$item->id) }}"
                                            class="btn btn-info waves-effect waves-light">Edit</a>
                                        <a href="{{ route('admin.delete_role',$item->id) }}"
