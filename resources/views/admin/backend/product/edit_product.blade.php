            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" action="{{ route('admin.product_update',$product->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="category_id" class="form-select">
                                            ...
                                            <option value="{{ $cat->id }}" {{ $cat->id == $product->category_id ?
                                                'selected' : '' }}>
                                                {{ $cat->category_name }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="client_id" class="form-select">
                                            ...
                                            <option value="{{ $clie->id }}" {{ $clie->id == $product->client_id ?
                                                'selected' : '' }}>
                                                {{ $clie->name }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="most_popular" type="checkbox" value="1" {{
