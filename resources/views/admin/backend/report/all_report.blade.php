                        ...
                        <div>
                            ...
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            <form id="myFormDate" action="{{ route('admin.get_all_report_by_date') }}"
                                                method="post">
                                                @csrf
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            <form id="myFormMonth" action="{{ route('admin.get_all_report_by_month') }}"
                                                method="post">
                                                @csrf
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            <form id="myFormYear" action="{{ route('admin.get_all_report_by_year') }}"
                                                method="post">
                                                @csrf
