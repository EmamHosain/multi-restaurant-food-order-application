                     ...
                     <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                           ...
                           <div class="form-label-group">
                              <input type="text" name="name" id="ptext" class="form-control @error('name')
                                 is-invalid
                              @enderror" autofocus placeholder="Email address" value="{{ old('name') }}">
                              <label for="ptext">Name </label>
                           </div>
                           <div class="form-label-group">
                              <input type="email" name="email" id="inputEmail" class="form-control @error('email')
                              is-invalid
                           @enderror" placeholder="Email address" value="{{ old('email') }}">
                           ...
                           <div class="form-label-group">
                              <input type="password" name="password_confirmation" id="inputPassword1" class="form-control @error('password_confirmation')
                                 is-invalid
                           ...
                           <div class="text-center pt-3">
                              Have an account? <a class="font-weight-bold" href="{{ route('login')}}">Sign
                                 In</a>
                           </div>
                        </form>
                        <hr class="my-4">
