...
<section class="restaurant-detailed-banner">
   <div class="text-center">
      <img class="img-fluid cover" style="width: 100%"
         src="{{ $client->cover_photo ?  asset($client->cover_photo ) : asset('upload/no_image.jpg') }}">
   </div>
            ...
            <div class="col-md-8">
               <div class="restaurant-detailed-header-left">
                  <img class="img-fluid mr-3 float-left" alt="osahan"
                     src="{{ $client->photo ?  asset( $client->photo ) : asset('upload/no_image.jpg') }}">
...
<section class="offer-dedicated-body pt-2 pb-2 mt-4 mb-4">
   <div class="container">
      <div class="row">
            ...
            <div class="offer-dedicated-body-left">
               <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel"
                     ...
                     @php
                     $populers =
                     App\Models\Product::where('status',1)->where('client_id',$client->id)->where('most_popular',1)->orderBy('id','desc')->take(5)->get();
                     @endphp
                     <div id="#menu" class="bg-white rounded shadow-sm p-4 mb-4 explore-outlets">
                        <h6 class="mb-3">Most Popular
                           @if ($coupons)
                           <span class="badge badge-success"><i class="icofont-tags"></i>
                              {{ $coupons->discount }}% Off All Items </span>

                           @else
                           <span class="badge badge-danger"><i class="icofont-tags"></i>
                              No offer Off All Items </span>
                           @endif
                        </h6>
                     ...
                     @php
                     $bestsellers =
                     App\Models\Product::with('city')->where('status',1)->where('client_id',$client->id)->where('best_seller',1)->orderBy('id','desc')->limit(3)->get();
                     @endphp
                     ...
                     <div class="row">
                        <h5 class="mb-4 mt-3 col-md-12">{{ ucfirst($menu->menu_name) }} <small
                              class="h6 text-black-50">{{
                              $menu->products->count() }} ITEMS</small></h5>
                        <div class="col-md-12">
                              ...
                              <div class="menu-list p-3 border-bottom">
                                 ...
                                 <div class="media">
                                    ...
                                    <div class="media-body">
                                       ...
                                       <p class="text-gray mb-0">${{ $product->price }} ({{ $product->size ?? '' }})
                                       </p>
                     ...
                     <div id="gallery" class="bg-white rounded shadow-sm p-4 mb-4">
                        <div class="restaurant-slider-main position-relative homepage-great-deals-carousel">
                           <div class="owl-carousel owl-theme homepage-ad">
                              ...
                              <div class="item">
                                 <img class="img-fluid" style="width: 100%" src="{{ asset($gallery->image) }}">
                                 <div class="position-absolute restaurant-slider-pics bg-dark text-white">{{ $index +
                                    1}} of {{ $gallerys->count() }} Photos</div>
                              </div>
                              @endforeach
                              ...
                              <div class="media-body">
                                 <div class="reviews-members-header">
                                    <span class="star-rating float-right">
                                       ...
                                       @endphp
                                       @for ($i = 1; $i <= 5; $i++) @if ($i <=$rating) <a href="#"><i
         ...
         use Carbon\Carbon;
         // get active coupon
         $coupon = App\Models\Coupon::where('client_id',$client->id)->where('validity_date','>=',
         Carbon::now()->format('Y-m-d'))->latest()->first();
         @endphp
