    ...
    <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
        <div class="list-card-image">
            ...
            <div class="favourite-heart text-danger position-absolute"><a
                    href="{{ route('restuarant_details',$product->client_id) }}"><i class="icofont-heart"></i></a></div>
        ...
        <div class="p-3 position-relative">
            <div class="list-card-body">
                <h6 class="mb-1"><a href="{{ route('restuarant_details',$product->client_id) }}" class="text-black"> {{
                        $product->name}}</a></h6>
