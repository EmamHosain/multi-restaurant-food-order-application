                              ...
                              <div class="custom-control custom-checkbox">
                                 ...
                                 <label class="custom-control-label"
                                    for="category-{{$category->id}}">{{$category->category_name}} <small
                                       class="text-black-50">({{$category->products_count}})</small>
                                 </label>
                              </div>
                              @endforeach
                           </div>
                        ...
                        <div id="collapseOnecity" class="collapse show" aria-labelledby="headingOnecity"
                           ...
                           <div class="filters-card-body card-shop-filters">
                              ...
                              <div class="custom-control custom-checkbox">
                                 ...
                                 <label class="custom-control-label" for="city-{{$city->id}}">{{$city->city_name}}
                                    <small class="text-black-50">({{$city->products_count}})</small>
                                 </label>
                              </div>
                              @endforeach
                           </div>
                  ...
                  <div id="accordion">
                     <div class="filters-card border-bottom p-4">
                        <div class="filters-card-header" id="headingOnemenu">
                           <h6 class="mb-0">
                              <a href="#" class="btn-link" data-toggle="collapse" data-target="#collapseOnemenu"
                                 aria-expanded="true" aria-controls="collapseOnemenu">
                        ...
                        <div id="collapseOnemenu" class="collapse show" aria-labelledby="headingOnemenu"
                           ...
                           <div class="filters-card-body card-shop-filters">
                              ...
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input filter-checkbox"
                                    id="menu-{{$menu->id}}" data-type="menu" data-id="{{$menu->id}}">
                                 <label class="custom-control-label" for="menu-{{$menu->id}}">{{$menu->menu_name}}
                                    <small class="text-black-50">({{$menu->products_count}})</small>
                                 </label>
                              </div>
                              @endforeach
                           </div>
                  ...
                  <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                     <div class="list-card-image">
                        ...
                        <div class="favourite-heart text-danger position-absolute"><a
                              href="{{ route('restuarant_details',$product->client_id) }}"><i
                                 class="icofont-heart"></i></a>
                        </div>
                        <div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
                        <a href="{{ route('restuarant_details',$product->client_id) }}">
                           <img src="{{ asset($product->image) }}" class="img-fluid item-img">
                        </a>
                     </div>
                     <div class="p-3 position-relative">
                        <div class="list-card-body">
                           <h6 class="mb-1"><a href="{{ route('restuarant_details',$product->client_id) }}"
                                 class="text-black">
                                 {{ $product->name}}</a></h6>
